...
class didx
{
    public function setupcost($cost)
    {
        if($cost !== "N/A")
    ...
    public function minutecharge($cost)
    {
        if($cost !== "N/A")
    ...
    public function freeminutes($mins)
    {
        return $mins/*+ add your profit here*/;
    }

    public function getAvailableDIDS($country, $area, $vendor=-1, $VRatingFrom=DIDX_MIN_RATING, $VRatingTo=10, $CountryID=-1)
    {
        $ret = true;
    ...
    //use SoapClient;
    public function getDIDCountry($VRatingFrom=DIDX_MIN_RATING,$VRatingTo=10)
    {
        $ret = true;
       ...
       // $client = new SoapClient(null, array('location' => "https://".DIDX_SITE."/cgi-bin/WebGetDIDCountriesServer.cgi",'connection_timeout' => 5,'uri'      => "http://".DIDX_SITE."/GetList"));
    ...
    public function GetCostOfDIDByNumber($DIDNumber)
    {
    ...
    public function BuyDIDByNumber($DIDNumber,$SIPorIAX, $Flag=1,$VendorID=-1)
    {
        $ret = true;
    ...
    public function  ReleaseDID($DIDNumber)
    {
        $ret = true;
    ...
    public function getAvailableRatedNXX($CountryCode, $NPA, $VRatingFrom=DIDX_MIN_RATING,$VRatingTo=10, $Vendor=-1)
    {
    ...
    public function getDIDCallLog($DIDNumber, $page=0)
    {
