...
include_once(dirname(__FILE__) . "/lib/Class.RateEngine.php");
include_once(dirname(__FILE__) . "/lib/phpagi/phpagi.php");
include_once(dirname(__FILE__) . "/lib/phpagi/phpagi-asmanager.php");
