...
CREATE TABLE IF NOT EXISTS `cc_card` (
  ...
  `language` char(5) collate utf8_bin default 'en',
  `redial` varchar(50) collate utf8_bin NOT NULL default '',
  ...
  `loginkey` varchar(40) collate utf8_bin NOT NULL default '',
  `mac_addr` char(17) collate utf8_bin NOT NULL default '00-00-00-00-00-00',
  `id_timezone` int(11) default '0',
  `tag` varchar(50) collate utf8_bin NOT NULL default '',
  ...
  `email_notification` varchar(70) collate utf8_bin NOT NULL default '',
  ...
  `company_name` varchar(50) collate utf8_bin NOT NULL default '',
  `company_website` varchar(60) collate utf8_bin NOT NULL default '',
  `vat_rn` varchar(40) collate utf8_bin default NULL,
  `traffic` bigint(20) default NULL,
  `traffic_target` varchar(300) collate utf8_bin NOT NULL default '',
...
CREATE TABLE IF NOT EXISTS `cc_iax_buddies` (
  ...
  `accountcode` varchar(20) collate utf8_bin NOT NULL default '',
  `regexten` varchar(20) collate utf8_bin NOT NULL default '',
  `amaflags` char(7) collate utf8_bin default NULL,
  `callgroup` char(10) collate utf8_bin default NULL,
  `callerid` varchar(80) collate utf8_bin NOT NULL default '',
  `canreinvite` varchar(20) collate utf8_bin NOT NULL default '',
  `context` varchar(80) collate utf8_bin NOT NULL default '',
  `DEFAULTip` char(15) collate utf8_bin default NULL,
  `dtmfmode` char(7) collate utf8_bin NOT NULL default 'RFC2833',
  `fromuser` varchar(80) collate utf8_bin NOT NULL default '',
  `fromdomain` varchar(80) collate utf8_bin NOT NULL default '',
  `host` varchar(31) collate utf8_bin NOT NULL default '',
  `insecure` varchar(20) collate utf8_bin NOT NULL default '',
  `language` char(2) collate utf8_bin default NULL,
  `mailbox` varchar(50) collate utf8_bin NOT NULL default '',
  `md5secret` varchar(80) collate utf8_bin NOT NULL default '',
  `nat` char(3) collate utf8_bin default 'yes',
  `permit` varchar(95) collate utf8_bin NOT NULL default '',
  `deny` varchar(95) collate utf8_bin NOT NULL default '',
  `mask` varchar(95) collate utf8_bin NOT NULL default '',
  ...
  `secret` varchar(80) collate utf8_bin NOT NULL default '',
  `type` char(6) collate utf8_bin NOT NULL default 'friend',
  `username` varchar(80) collate utf8_bin NOT NULL default '',
  `disallow` varchar(100) collate utf8_bin NOT NULL default '',
  `allow` varchar(100) collate utf8_bin NOT NULL default '',
...
CREATE TABLE IF NOT EXISTS `cc_sip_buddies` (
  ...
  `ipaddr` char(15) collate utf8_bin NOT NULL default '',
  `cancallforward` char(3) collate utf8_bin default 'yes',
  `fullcontact` varchar(80) collate utf8_bin NOT NULL default '',
