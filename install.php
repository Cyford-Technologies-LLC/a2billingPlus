...
$defaults = [
    ...
    'asterisk_channel_driver' => getenv('A2BP_ASTERISK_CHANNEL_DRIVER') ?: 'pjsip',
    'asterisk_realtime' => getenv('A2BP_ASTERISK_REALTIME') ?: 'yes',
    'initialize_schema' => '',
    'run_compose' => '',
    'compose_php84' => '',
    'compose_asterisk' => '',
...
function writeEnvFile(string $envPath, string $envExamplePath, array $input, array &$messages, array &$errors): void
{
    ...
    $values = [
        ...
        'A2BP_ASTERISK_CHANNEL_DRIVER' => $input['asterisk_channel_driver'],
        'A2BP_ASTERISK_REALTIME' => $input['asterisk_realtime'],
        'A2BP_ASTERISK_RUNTIME_DIR' => './var/runtime/asterisk',
